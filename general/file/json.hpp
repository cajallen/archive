...
using json_variant = variant<json, vector<json_value>, string, bool, int64, double>;
...
json_value to_jv(T input_float) {
    json_value jv;
    jv.value = json_variant{(double) input_float};
    return jv;
}
...
json_value to_jv(T input_int) {
    json_value jv;
    jv.value = json_variant{(int64) input_int};
    return jv;
}
...
T from_jv_impl(const json_value& jv, T* _) {
    return (T) get<int64>(jv.value);
}

template <float_concept T>
T from_jv_impl(const json_value& jv, T* _) {
    return (T) get<double>(jv.value);
}
...
#define EXPAND(x) x
#define GET_MACRO(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, NAME, ...) NAME
#define PASTE(...) \
    EXPAND(GET_MACRO(__VA_ARGS__, PASTE23, PASTE22, PASTE21, PASTE20, PASTE19, PASTE18, PASTE17, PASTE16, PASTE15, PASTE14, PASTE13, PASTE12, PASTE11, PASTE10, PASTE9, PASTE8, PASTE7, PASTE6, PASTE5, PASTE4, PASTE3, PASTE2, PASTE1)(__VA_ARGS__))
...
#define PASTE21(func, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20) PASTE2(func, v1) PASTE20(func, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20)
#define PASTE22(func, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21) PASTE2(func, v1) PASTE21(func, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21)
#define PASTE23(func, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22) PASTE2(func, v1) PASTE22(func, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22)
