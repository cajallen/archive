...
template <typename T> struct v2_ {
    ...
    const constexpr T& operator[](int32 i) const {
        return data[i];
    }
...
typedef v2_<float> v2;
typedef v2_<int32> v2i;

typedef v3_<float> v3;
typedef v3_<int32> v3i;

typedef v4_<float> v4;
typedef v4_<int32> v4i;
...
struct euler {
    ...
    constexpr euler operator*(float f) {
...
inline v3_<float> operator%(v3_<float> v1, v3_<float> v2) {
    return v3_(std::fmod(v1.x, v2.x), std::fmod(v1.y, v2.y), std::fmod(v1.z, v2.z));
}
inline v3_<float> operator%(v3_<float> v, float s) {
...
struct hash<spellbook::v2_<T>> {
    uint64 operator()(const spellbook::v2_<T>& vec) const {
...
struct hash<spellbook::v3_<T>> {
    uint64 operator()(const spellbook::v3_<T>& vec) const {
