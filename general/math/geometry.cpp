...
line_<float>::operator v2() const {
    return v2{start, end};
}


constexpr v2_<int32>::v2_(vuk::Extent2D vk_extent) {
    x = vk_extent.width; y = vk_extent.height;
}
constexpr v2_<int32>::v2_(vuk::Extent3D vk_extent) {
    x = vk_extent.width; y = vk_extent.height;
}
constexpr v3_<int32>::v3_(vuk::Extent2D vk_extent) {
    x = vk_extent.width; y = vk_extent.height; z = 1;
}
constexpr v3_<int32>::v3_(vuk::Extent3D vk_extent) {
    x = vk_extent.width; y = vk_extent.height; z = vk_extent.depth;
}

constexpr v2_<float>::v2_(vuk::Extent2D vk_extent) {
    x = vk_extent.width; y = vk_extent.height;
}
constexpr v2_<float>::v2_(vuk::Extent3D vk_extent) {
    x = vk_extent.width; y = vk_extent.height;
}
constexpr v3_<float>::v3_(vuk::Extent2D vk_extent) {
    x = vk_extent.width; y = vk_extent.height; z = 1;
}
constexpr v3_<float>::v3_(vuk::Extent3D vk_extent) {
    x = vk_extent.width; y = vk_extent.height; z = vk_extent.depth;
}

constexpr v2_<float>::operator vuk::Extent2D() const {
    return vuk::Extent2D{(uint32) math::round(x), (uint32) math::round(y)};
}

constexpr v2_<float>::operator vuk::Extent3D() const {
    return vuk::Extent3D{(uint32) math::round(x), (uint32) math::round(y), 1};
}

constexpr v2_<int32>::operator vuk::Extent2D() const {
    return vuk::Extent2D{(uint32) x, (uint32) y};
}

constexpr v2_<int32>::operator vuk::Extent3D() const {
    return vuk::Extent3D{(uint32) x, (uint32) y, 1};
}

constexpr v3_<float>::operator vuk::Extent2D() const {
    return vuk::Extent2D{(uint32) math::round(x), (uint32) math::round(y)};
}

constexpr v3_<float>::operator vuk::Extent3D() const {
    return vuk::Extent3D{(uint32) math::round(x), (uint32) math::round(y), (uint32) math::round(z)};
}

constexpr v3_<int32>::operator vuk::Extent2D() const {
    return vuk::Extent2D{(uint32) x, (uint32) y};
}

constexpr v3_<int32>::operator vuk::Extent3D() const {
    return vuk::Extent3D{(uint32) x, (uint32) y, (uint32) z};
}
