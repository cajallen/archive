...
#define COLOR_VIEW(var) { \
    float var##copy[4] = { var.r, var.g, var.b, var.a }; \
...
void color_window(bool* p_open) {
    if (ImGui::Begin("Colors", p_open)) {
        ...
        COLOR_VIEW(spellbook_gray)

        COLOR_VIEW(academy_0)
        COLOR_VIEW(academy_1)
        COLOR_VIEW(academy_2)
        COLOR_VIEW(academy_3)
        COLOR_VIEW(academy_4)
        COLOR_VIEW(academy_5)
        COLOR_VIEW(academy_6)
        COLOR_VIEW(academy_7)
        COLOR_VIEW(academy_8)
        COLOR_VIEW(academy_gray)
